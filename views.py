...
def team_members(name):
    if name=='abhiram':
        return render_template('abhiram.html',title='Abhiram R')
    if name=='anandita':
        return render_template('anandita.html',title='Anandita Choudhary')
    if name=='babloo':
        return render_template('babloo.html',title='Babloo Kumar')
